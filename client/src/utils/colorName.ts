// Map an arbitrary hex colour to the nearest human-friendly colour name.
...
/** Display label for a colour value — name when it's a hex, else the value itself. */
export const colorLabel = (value?: string): string =>
  value ? (isHex(value) ? colorNameFromHex(value) : value) : '';
